...
This plugin also create a Image gallery menu tab in WordPress menu section and display Gallery on frontend of your website in a slider OR carousel view with the help of shorcode. The gallery field provides a simple and intuitive interface for managing a collection of images.

View [DEMO](https://www.wponlinesupport.com/wp-plugin/meta-slider-carousel-lightbox/) | [PRO DEMO](https://www.wponlinesupport.com/wp-plugin/meta-slider-carousel-lightbox/)  for additional information.

Checkout our new plugin (10 sliders in one plugin) - [SlidersPack – All In One Image/Post Slider](https://wordpress.org/plugins/sliderspack-all-in-one-image-sliders/)
