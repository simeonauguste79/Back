---------------------EXERCICE créer une base de donnée--------------------------------------
CREATE DATABASE magasin;
--------Créer une table de produit qui contient les colonnes suivantes:
---id ==> INT PRIMARY KEY AUTO_INCREMENT NOT NULL
CREATE TABLE voitures(id-car INT(3) PRIMARY KEY AUTO_INCREMENT, marque VARCHAR (50), model VARCHAR (60), couleur VARCHAR(30,), prix FLOAT, date_vente DATE);
...
type => DATE ------a-m-j-
     ...
     => TIME 
     => YEAR -199--
------Inserer au moins 20 produits
INSERT INTO voitures(marque, model, couleur, prix, date_vente) VALUES('Lamborgini', 'Countach', 'blanc', '33000', '2018-02-30');
