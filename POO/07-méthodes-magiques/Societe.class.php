...
class Societe
{
    ...
    // __call() est une méthode magique qui s'execute automatiquement en cas de tentative d'execution d'une méthode qui n'a pas été déclarée
}

$societe = new Societe;

$societe->villes = "Paris"; // tentative d'affectatiuon d'une propriété qui n'a pas été déclarée
