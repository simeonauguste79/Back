...
// $donnees correspond à l'indice 'donnees' déclaré dans la méthode render() du controller
...
<thead><tr>
    <th>ID</th><!-- on créer manuellement un champ,nous l'avons supprimer au moment de la requete SQL dans EntityRepository -->
